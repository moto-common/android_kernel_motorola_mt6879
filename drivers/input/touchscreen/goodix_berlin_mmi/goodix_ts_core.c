...
#if IS_ENABLED(CONFIG_DRM_MEDIATEK) && !defined(CONFIG_INPUT_TOUCHSCREEN_MMI)
...
static int goodix_ts_probe(struct platform_device *pdev)
{
	...
	if (mtk_panel_tch_handle_init()) {
		...
		*mtk_ret = (void *)goodix_ts_power_on_reinit;
	}
#endif
